...
public:
    ...
    static int getExchangeIdFromStockTicker(const char* ticker);
...
inline int EngineUtil::getExchangeIdFromStockTicker(const char* ticker)
{
    switch (ticker[0])
    {
...
{
    int exchange_id = getExchangeIdFromStockTicker(ticker);
