...
TDUserInfoHelper::TDUserInfoHelper(int source): source(source)
{
    address_book.clear();
}

TDUserInfoHelper::TDUserInfoHelper(int source, const string& user_name): TDUserInfoHelper(source)
{
...
/** TDEngineInfoHelper */
TDEngineInfoHelper::TDEngineInfoHelper(int source, const string& name)
{
    std::stringstream ss;
