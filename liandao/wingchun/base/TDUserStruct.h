...
#define ORDER_INFO_TICKER_LIMIT 32
...
class TDUserInfoHelper
{
    ...
    friend bool set_pos_tool(const string& user_name, int source, const string& file_name, bool is_csv);
...
public:
    ...
    TDUserInfoHelper(int source, const string& user_name);
    /** get const user info */
...
protected:
    TDEngineInfoHelper(int source, const string& name);
