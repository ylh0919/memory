#ifndef WINGCHUN_MDENGINEOKEXF_H
#define WINGCHUN_MDENGINEOKEXF_H
...
class MDEngineOkexF: public IMDEngine
{
public:
    ...
    virtual string name() const { return "MDEngineOkexF"; };
...
/*    inline int64_t getTimestamp();
 ...
 /*   SubscribeChannel findByChannelID(int channelId);
    ...
    std::string createBookJsonString(std::vector<std::string>& exchange_coinpairs);
    std::string createTradeJsonString(std::vector<std::string>& exchange_coinpairs);
    std::string createCandleJsonString(std::vector<std::string>& exchange_coinpairs);
    std::string createCandleJsonString(std::vector<std::string>& exchange_coinpairs, std::string interval);
    std::string createFundingJsonString(std::vector<std::string>& exchange_coinpairs);
    std::string getTickerType(std::string exchange_coinpair);
    ...
    void addWsString(std::vector<std::string>& ticker,bool isSwap = false);
    string replaceTicker(string str);
private:
