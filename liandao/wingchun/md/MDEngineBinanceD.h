#ifndef WINGCHUN_MDENGINEBINANCED_H
#define WINGCHUN_MDENGINEBINANCED_H
...
class MDEngineBinanceD : public IMDEngine
{
public:
    struct pair
    {
...
public:
    ...
    virtual string name() const { return "MDEngineBinanceD"; };
