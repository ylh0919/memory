#ifndef WINGCHUN_MDENGINECOINCHECK_H
#define WINGCHUN_MDENGINECOINCHECK_H
...
class MDEngineCoincheck: public IMDEngine,public common::CWebsocketCallBack
{
public:
    ...
    virtual string name() const { return "MDEngineCoincheck"; };
...
private:
    ...
    void onBook(Document& json,std::string exchange_coinpair);
    void onTrade(Document& json,std::string exchange_coinpair);
    void initBook(std::string strategy_coinpair, std::string exchange_coinpair);
    void initSnapshot();
