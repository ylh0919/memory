...
#ifndef WINGCHUN_MDENGINEQDP_H
#define WINGCHUN_MDENGINEQDP_H
...
class MDEngineQDP: public IMDEngine, public CQdpFtdcMduserSpi
{
public:
    ...
    virtual string name() const { return "MDEngineQDP"; };
...
private:
    ...
    //load and sub
    map<string, CoinPairWhiteList> whiteListsForExchange;
...
DECLARE_PTR(MDEngineQDP);

WC_NAMESPACE_END

#endif //WINGCHUN_MDENGINEQDP_H
