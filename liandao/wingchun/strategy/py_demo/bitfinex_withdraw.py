'''
wingchun strategy -n my_test -p /liandao/wingchun/strategy/py_demo/bitfinex_withdraw.py
'''
    ...
    if request_id == -1:
        if pos_handler is None:
            ...
            if context.order_rid < 0:
                ...
                context.order_rid = context.withdraw_currency(source=SOURCE.BITFINEX,
                                                               currency="BITCOIN",
                                                               volume=200000,
                                                               address="",
                                                               tag="")
