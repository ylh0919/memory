...
Z = []
AC = []
path = "/shared/jpy_usd_coinflex/jpy_usd_coinflex.csv"
...
with open("/shared/jpy_usd_coinflex/md_coinflex.csv",'w') as f:
    csv_write = csv.writer(f)
...
with open("/shared/jpy_usd_coinflex/md_bitflyer.csv",'w') as f:
    csv_write = csv.writer(f)
        ...
        if price_book.InstrumentID == "fx_btc_jpy":
            ...
            if coinflex_data != []:
                ...
                with open(path,'a+') as f:
                    ...
                    print("coinflex_bitflyer_jpy_usd")
                    print(data_row)

                with open("/shared/jpy_usd_coinflex/md_coinflex.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["btc_usd"]
                    data_row.append(timestamp_tran_time(coinflex_time))
                    data_row.append(coinflex_time)
                    ...
                    csv_write.writerow(data_row)
                with open("/shared/jpy_usd_coinflex/md_bitflyer.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["fx_btc_jpy"]
                    data_row.append(timestamp_tran_time(bitflyer_time))
                    data_row.append(bitflyer_time)
