...
Z = []
AC = []
path = "/shared/jpy_usd_hbdm/jpy_usd_hbdm.csv"
...
with open("/shared/jpy_usd_hbdm/md_hbdm.csv",'w') as f:
    csv_write = csv.writer(f)
...
with open("/shared/jpy_usd_hbdm/md_bitflyer.csv",'w') as f:
    csv_write = csv.writer(f)
        ...
        if price_book.InstrumentID == "fx_btc_jpy":
            ...
            if hbdm_data != []:
                ...
                with open(path,'a+') as f:
                    ...
                    print("hbdm_bitflyer_jpy_usd")
                    print(data_row)

                with open("/shared/jpy_usd_hbdm/md_hbdm.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["btc_cq"]
                    data_row.append(timestamp_tran_time(hbdm_time))
                    data_row.append(hbdm_time)
                    ...
                    csv_write.writerow(data_row)
                with open("/shared/jpy_usd_hbdm/md_bitflyer.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["fx_btc_jpy"]
                    data_row.append(timestamp_tran_time(bitflyer_time))
                    data_row.append(bitflyer_time)
