'''
wingchun strategy -n my_test -p /liandao/wingchun/strategy/py_demo/bitfinex_transfer.py
'''
    ...
    if request_id == -1:
        if pos_handler is None:
            ...
            if context.order_rid < 0:
                ...
                context.order_rid = context.req_inner_transfer(source=SOURCE.BITFINEX,
                                                               currency="BTC",
                                                               volume=200000,
                                                               from_type = "exchange",
                                                               from_name="",
