...
def on_pos(context, pos_handler, request_id, source, rcv_time):
    ...
    if request_id == -1:
        if pos_handler is None:
            ...
            context.req_pos(source=SOURCE.KUCOIN,account_type="master-main",account_name="")
	    ...
	    #return 
            ...
            if context.order_rid < 0:
                ...
                context.order_rid = context.req_inner_transfer(source=SOURCE.KUCOIN,
                                                               currency="XRP",
                                                               volume=2500000000,
                                                               from_type = "sub-trade",
                                                               to_type="sub-main",
							                                   from_name="Beavoinvest2",
                                                               to_name="Beavoinvest2")
