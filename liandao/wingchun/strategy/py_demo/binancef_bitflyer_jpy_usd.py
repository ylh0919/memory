...
Z = []
AC = []
path = "/shared/jpy_usd_binancef/jpy_usd_binancef.csv"
...
with open("/shared/jpy_usd_binancef/md_binancef.csv",'w') as f:
    csv_write = csv.writer(f)
...
with open("/shared/jpy_usd_binancef/md_bitflyer.csv",'w') as f:
    csv_write = csv.writer(f)
        ...
        if price_book.InstrumentID == "fx_btc_jpy":
            ...
            if binancef_data != []:
                ...
                with open(path,'a+') as f:
                    ...
                    print("binancef_bitflyer_jpy_usd")
                    print(data_row)

                with open("/shared/jpy_usd_binancef/md_binancef.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["btc_usd"]
                    data_row.append(timestamp_tran_time(binancef_time))
                    data_row.append(binancef_time)
                    ...
                    csv_write.writerow(data_row)
                with open("/shared/jpy_usd_binancef/md_bitflyer.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["fx_btc_jpy"]
                    data_row.append(timestamp_tran_time(bitflyer_time))
                    data_row.append(bitflyer_time)
