'''
wingchun strategy -n my_test -p /liandao/wingchun/strategy/py_demo/binance_withdraw.py
'''
    ...
    if request_id == -1:
        if pos_handler is None:
            ...
            if context.order_rid < 0:
                ...
                context.order_rid = context.withdraw_currency(source=SOURCE.BINANCE,
                                                               currency="BTC",
                                                               volume=200000,
                                                               address="37RFHcW2JdXq5wyHHxsFkKKNa2awrkAVo8",
                                                               tag="",
                                                               key="608885f245e5426c9d38921ada92c081")
