...
Z = []
AC = []
path = "/shared/jpy_usd_kumex/jpy_usd_kumex.csv"
...
with open("/shared/jpy_usd_kumex/md_kumex.csv",'w') as f:
    csv_write = csv.writer(f)
...
with open("/shared/jpy_usd_kumex/md_bitflyer.csv",'w') as f:
    csv_write = csv.writer(f)
        ...
        if price_book.InstrumentID == "fx_btc_jpy":
            ...
            if kumex_data != []:
                ...
                with open(path,'a+') as f:
                    ...
                    print("kumex_bitflyer_jpy_usd")
                    print(data_row)

                with open("/shared/jpy_usd_kumex/md_kumex.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["btc_usd"]
                    data_row.append(timestamp_tran_time(kumex_time))
                    data_row.append(kumex_time)
                    ...
                    csv_write.writerow(data_row)
                with open("/shared/jpy_usd_kumex/md_bitflyer.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["fx_btc_jpy"]
                    data_row.append(timestamp_tran_time(bitflyer_time))
                    data_row.append(bitflyer_time)
