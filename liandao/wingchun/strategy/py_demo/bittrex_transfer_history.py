'''
wingchun strategy -n my_test -p /liandao/wingchun/strategy/py_demo/bittrex_transfer_history.py
'''
    ...
    if request_id == -1:
        if pos_handler is None:
            ...
            if context.order_rid < 0:
                ...
                context.order_rid = context.transfer_history(source=SOURCE.BITTREX,
                                                             flag=False,                   #flase for deposit,true for withdraw
                                                             curreny="",
                                                             status= -1,
                                                             start_Time="",
                                                             end_Time="",
