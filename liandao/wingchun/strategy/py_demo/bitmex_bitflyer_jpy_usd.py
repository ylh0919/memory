...
Z = []
AC = []
path = "/shared/jpy_usd_bitmex/jpy_usd_bitmex.csv"
...
with open("/shared/jpy_usd_bitmex/md_bitmex.csv",'w') as f:
    csv_write = csv.writer(f)
...
with open("/shared/jpy_usd_bitmex/md_bitflyer.csv",'w') as f:
    csv_write = csv.writer(f)
        ...
        if price_book.InstrumentID == "fx_btc_jpy":
            ...
            if bitmex_data != []:
                ...
                with open(path,'a+') as f:
                    ...
                    print("bitmex_bitflyer_jpy_usd")
                    print(data_row)

                with open("/shared/jpy_usd_bitmex/md_bitmex.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["btc_usd"]
                    data_row.append(timestamp_tran_time(bitmex_time))
                    data_row.append(bitmex_time)
                    ...
                    csv_write.writerow(data_row)
                with open("/shared/jpy_usd_bitmex/md_bitflyer.csv",'a+') as f:
                    csv_write = csv.writer(f)
                    data_row = ["fx_btc_jpy"]
                    data_row.append(timestamp_tran_time(bitflyer_time))
                    data_row.append(bitflyer_time)
