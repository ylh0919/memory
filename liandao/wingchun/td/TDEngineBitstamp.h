...
private:
    ...
    void getPrecision();
    void handle_order_insert(AccountUnitBitstamp& unit,const LFInputOrderField data,int requestId,const std::string& ticker);
    void handle_order_action(AccountUnitBitstamp& unit,const LFOrderActionField data, int requestId,const std::string& ticker);
public:
