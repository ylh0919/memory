...
void StrategyDataConsumer::on_pos_set(json& j_pos, int source, long rcv_time, const string& name)
{
    if (name.compare(strategy_name) == 0 && (tar_session <= 0 || tar_session == cur_session))
    {
...
void StrategyDataConsumer::on_td_connect(json& j_request, int source, long rcv_time, const string& name)
{
    if (name.compare(strategy_name) == 0 && (tar_session <= 0 || tar_session == cur_session))
    {
        // add td journal
...
void StrategyDataConsumer::on_td_ack(json& j_ack, int source, long rcv_time, const string& name)
{
    if (name.compare(strategy_name) == 0 && (tar_session <= 0 || tar_session == cur_session))
    {
...
void StrategyDataConsumer::on_order_origin(LFInputOrderField* order, int source, int order_id, long rcv_time, long md_nano, const string& name)
{
    if (tar_session <= 0 || tar_session == cur_session)
    {
...
void StrategyDataConsumer::on_order_send(LFInputOrderField* order, int source, int order_id, long after_nano, long before_nano)
{
    if (tar_session <= 0 || tar_session == cur_session)
    {
        if (order_map.find(order_id) != order_map.end())
...
void StrategyDataConsumer::on_rtn_order(LFRtnOrderField* order, int source, int order_id, long rcv_time)
{
    if (tar_session <= 0 || tar_session == cur_session)
    {
        if (order_map.find(order_id) != order_map.end())
...
void StrategyDataConsumer::on_rtn_trade(LFRtnTradeField* trade, int source, int order_id, long rcv_time)
{
    if (tar_session <= 0 || tar_session == cur_session)
    {
        if (order_map.find(order_id) != order_map.end())
