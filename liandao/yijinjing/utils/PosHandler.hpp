...
typedef int64_t VOLUME_DATA_TYPE;
...
public:
    PosHandler(int source,std::string account_type = "" ,std::string account_name=""): is_poisoned(false), source(source)
    {
    ...
    static PosHandlerPtr create(int source);
    static PosHandlerPtr create(int source,std::string account_type ,std::string account_name);
    static PosHandlerPtr create(int source, const string& js_str);
    static PosHandlerPtr create(int source, json js);
    ...
    static inline bool is_stock(int source)
    {
    ...
    inline std::string get_account_type() const
    {
        return account_type;
    }
...
inline PosHandlerPtr PosHandler::create(int source)
{
    PosHandlerPtr res = PosHandlerPtr(new PosHandler(source));
    return res;
}

inline PosHandlerPtr PosHandler::create(int source,std::string account_type,std::string account_name)
{
    PosHandlerPtr res = PosHandlerPtr(new PosHandler(source,account_type,account_name));
    return res;
}

inline PosHandlerPtr PosHandler::create(int source, const string& js_str)
{
    PosHandlerPtr res = PosHandlerPtr(new PosHandler(source));
    res->init(js_str);
    return res;
...
inline PosHandlerPtr PosHandler::create(int source, json js)
{
    PosHandlerPtr res = PosHandlerPtr(new PosHandler(source));
    res->init_js(js);
    return res;
