...
public:
    ...
    bool write(string content, int msg_type, bool is_last=true, int source=0);
...
public:
    ...
    bool    sub_md(const vector<string>& tickers, int source, int msgType, bool isLast);
    bool    login_td(const string& clientName, int source);
