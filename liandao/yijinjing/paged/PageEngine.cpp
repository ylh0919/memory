...
bool PageEngine::write(string content, int msg_type, bool is_last, int source)
{
...
int PageEngine::reg_journal(const string& clientName)
{
    ...
    KF_LOG_INFO(logger, "PageEngine::reg_journal " << " (idx)" << idx);
...
bool PageEngine::login_td(const string& clientName, int source)
{
...
bool PageEngine::sub_md(const vector<string>& tickers, int source, int msg_type, bool isLast)
{
