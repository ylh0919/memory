...
public:
    ...
    bool td_connect(int source);
    /** override IStrategyUtil */
    bool md_subscribe(const vector<string>& tickers, int source, int msg_type);
    /** override IStrategyUtil */
    ...
    bool subscribeMarketData(const vector<string>& tickers, int source);
    /** subscribe md with L2_MD flag */
    bool subscribeL2MD(const vector<string>& tickers, int source);
    /** subscribe md with INDEX flag */
    bool subscribeIndex(const vector<string>& tickers, int source);
    /** subscribe md with ORDER_TRADE flag */
    bool subscribeOrderTrade(const vector<string>& tickers, int source);
