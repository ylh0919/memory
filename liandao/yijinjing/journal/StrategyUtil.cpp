...
bool StrategyUtil::td_connect(int source)
{
...
bool StrategyUtil::md_subscribe(const vector<string>& tickers, int source, int msg_type)
{
    if (handler.get() != nullptr)
...
bool StrategyUtil::subscribeMarketData(const vector<string>& tickers, int source)
{
    return md_subscribe(tickers, source, MSG_TYPE_SUBSCRIBE_MARKET_DATA);
}

bool StrategyUtil::subscribeL2MD(const vector<string>& tickers, int source)
{
    return md_subscribe(tickers, source, MSG_TYPE_SUBSCRIBE_L2_MD);
}

bool StrategyUtil::subscribeIndex(const vector<string>& tickers, int source)
{
    return md_subscribe(tickers, source, MSG_TYPE_SUBSCRIBE_INDEX);
}

bool StrategyUtil::subscribeOrderTrade(const vector<string>& tickers, int source)
{
