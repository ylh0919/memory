...
public:
    ...
    virtual bool login(const std::string& name, const std::string& type, const std::string& max_run_time) = 0;
    virtual bool login(const std::string& name, const std::string& type, int pid) = 0;
    virtual bool td_strategy(const std::string& name, const std::string& type, const vector<string> sts) = 0;
