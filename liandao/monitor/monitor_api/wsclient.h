...
public:
    ...
    virtual bool login(const std::string& name, const std::string& type, const std::string& max_run_time) override;
    virtual bool login(const std::string& name, const std::string& type, int pid) override;
    virtual bool td_strategy(const std::string& name, const std::string& type, const vector<string> sts);
